...
class SRModel(BaseModel):
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            sr_img = DataUtil.tensor_to_image([visuals['result']])
            metric_data['img'] = sr_img
            if 'gt' in visuals:
                gt_img = DataUtil.tensor_to_image([visuals['gt']])
            ...
            if save_img:
                ...
                DataUtil.image_write_by_rasterio(sr_img, save_img_path, channel_axis=2)
